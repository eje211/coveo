...
class PGPointSpec extends WordSpec with Matchers {
  ...
  "The PGpoint converters" can {
    "the converter from PGpoint to Vector" should {
    ...
    "the converter from Vector to PGpoint" should {
    ...
    "the converter from String to PGpoint" should {
